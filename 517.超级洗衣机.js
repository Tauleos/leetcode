...
var findMinMoves = function (machines) {
	let total = machines.reduce((pre, cur) => pre + cur, 0);
	...
	for (let i of machines) {
		let extra = i - average;
		prefixExtra += extra;
		// console.log('prefixExtra', prefixExtra);
		res = Math.max(res, Math.abs(prefixExtra), extra);
	}
	// console.log('prefixExtra', prefixExtra);
	return res;
};
// console.log(findMinMoves([0, 0, 11, 5]));
// @lc code=end
