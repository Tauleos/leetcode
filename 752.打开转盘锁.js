...
function plusOne(cur, index) {
	...
	return replaceStringIndex(cur, index, item);
}
function minusOne(cur, index) {
	let item = cur[index];
	if (item === '0') {
		item = '9';
	} else {
...
function replaceStringIndex(str, index, replacer) {
	const strArr = str.split('');
	strArr[index] = replacer;
	return strArr.join('');
}
// @lc code=end
